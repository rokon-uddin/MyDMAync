...
let logger = Logger(subsystem: "me.rokon.download-manager", category: "default")

/// Manages a queue of http download tasks.

public actor DownloadManager: NSObject, ObservableObject {
    ...
    public private(set) var maxConcurrentDownloads: Int = 10
